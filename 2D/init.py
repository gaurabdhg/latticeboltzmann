...
def defineConstants(characteristicLength):
  ...
  if not characteristicLength:
    characteristicLength=OBJ_RADII_IDX
  ...
  KIN_viscosity = VMAX_IN_X*characteristicLength / REYNOLDS_NO
